...
export function ProductSalesTab({ productId, isCombo = false }: ProductSalesTabProps) {
  ...
  return (
    <div className="grid grid-cols-12 gap-6">
      ...
      <div className="col-span-12 lg:col-span-9 space-y-6">
        {/* Variant Type Builder - hidden for combo products */}
        {!isCombo && (mode === "existing" || variantDrafts.length === 0) && (
        ...
        {isCombo && (
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-amber-800">Sản phẩm Combo</p>
              <p className="text-xs text-amber-700 mt-0.5">Sản phẩm combo chỉ có 1 phân loại duy nhất, không thể thêm hoặc xóa phân loại.</p>
            </div>
          </div>
        )}
